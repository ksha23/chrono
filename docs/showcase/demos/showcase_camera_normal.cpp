// SHOWCASE: Chrono::Sensor Metal RT backend -- Normal camera (ChNormalCamera).
...
// then returns. HEADLESS. PNGs -> demos_live/showcase_out/camera_normal/
#include <cmath>
#include <cstdio>
#include <cstdlib>
#include <string>
...
int main(int argc, char** argv) {
    ...
    cam->PushFilter(chrono_types::make_shared<ChFilterSave>("demos_live/showcase_out/camera_normal/"));
    manager->AddSensor(cam);

    printf("Showcase Normal camera (Metal). PNGs -> demos_live/showcase_out/camera_normal/\n");
