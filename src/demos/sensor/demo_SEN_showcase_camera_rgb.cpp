...
int main(int argc, char** argv) {
    ...
    auto cam = chrono_types::make_shared<ChCameraSensor>(audi.GetChassisBody(), 500.0f, ChFrame<double>(), 1280, 720, (float)(CH_PI / 3), 2 /*supersample*/,
                                                         CameraLensModelType::PINHOLE, false /*GI*/, false /*denoiser*/);
