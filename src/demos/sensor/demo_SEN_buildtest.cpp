...
int main(int argc, char* argv[]) {
    ...
    // backend-neutral ChScene::ModifyPointLight overload, so their state is tracked here
    ...
    while (ch_time < end_time) {
        ...
        p0_pos = ChVector3f((float)(-orbit_radius * cos(ch_time * orbit_rate * 2)),
                            (float)(-orbit_radius * sin(ch_time * orbit_rate * 2)), 10.f);
