...
//
// =============================================================================
// Quarter-panel comparison scene (OPTIX / reference backend).
//
// This is the OptiX-backend twin of demos_live/quarterpanel.cpp (the Metal backend). It builds the SAME
// scene: a stationary Audi on a flat terrain patch under the shipped sensor/textures/sky_2_4k.hdr HDR, with
// the camera parked looking at the LEFT REAR QUARTER PANEL. Purpose: render this on OptiX so we can compare
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "Done. Compare quarterpanel_out/optix/ against the Metal backend's quarterpanel_out/metal/.\n";
    return 0;
}
