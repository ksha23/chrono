...
void SphForceWCSPH::CrmCalcRHS(std::shared_ptr<SphMarkerDataD> sortedSphMarkersD) {
    ...
    switch (m_data_mgr.paramsH->shifting_method) {
        case ShiftingMethod::NONE:
            LaunchCrmCalcRHS<ShiftingMethod::NONE>(numBlocks, numThreads, m_data_mgr, sortedSphMarkersD, numActive, error_flagD);
            break;
        case ShiftingMethod::XSPH:
            LaunchCrmCalcRHS<ShiftingMethod::XSPH>(numBlocks, numThreads, m_data_mgr, sortedSphMarkersD, numActive, error_flagD);
            break;
        case ShiftingMethod::PPST:
            LaunchCrmCalcRHS<ShiftingMethod::PPST>(numBlocks, numThreads, m_data_mgr, sortedSphMarkersD, numActive, error_flagD);
            break;
        case ShiftingMethod::PPST_XSPH:
            LaunchCrmCalcRHS<ShiftingMethod::PPST_XSPH>(numBlocks, numThreads, m_data_mgr, sortedSphMarkersD, numActive, error_flagD);
            break;
        case ShiftingMethod::DIFFUSION:
            LaunchCrmCalcRHS<ShiftingMethod::DIFFUSION>(numBlocks, numThreads, m_data_mgr, sortedSphMarkersD, numActive, error_flagD);
            break;
        case ShiftingMethod::DIFFUSION_XSPH:
            LaunchCrmCalcRHS<ShiftingMethod::DIFFUSION_XSPH>(numBlocks, numThreads, m_data_mgr, sortedSphMarkersD, numActive, error_flagD);
            break;
    }
...
void SphForceWCSPH::CfdCalcRHS(std::shared_ptr<SphMarkerDataD> sortedSphMarkersD) {
    ...
    switch (m_data_mgr.paramsH->shifting_method) {
        case ShiftingMethod::NONE:
            LaunchCfdCalcRHS<ShiftingMethod::NONE>(numBlocks, numThreads, m_data_mgr, sortedSphMarkersD, numActive, error_flagD);
            break;
        case ShiftingMethod::XSPH:
            LaunchCfdCalcRHS<ShiftingMethod::XSPH>(numBlocks, numThreads, m_data_mgr, sortedSphMarkersD, numActive, error_flagD);
            break;
        case ShiftingMethod::PPST:
            LaunchCfdCalcRHS<ShiftingMethod::PPST>(numBlocks, numThreads, m_data_mgr, sortedSphMarkersD, numActive, error_flagD);
            break;
        case ShiftingMethod::PPST_XSPH:
            LaunchCfdCalcRHS<ShiftingMethod::PPST_XSPH>(numBlocks, numThreads, m_data_mgr, sortedSphMarkersD, numActive, error_flagD);
            break;
        case ShiftingMethod::DIFFUSION:
            LaunchCfdCalcRHS<ShiftingMethod::DIFFUSION>(numBlocks, numThreads, m_data_mgr, sortedSphMarkersD, numActive, error_flagD);
            break;
        case ShiftingMethod::DIFFUSION_XSPH:
            LaunchCfdCalcRHS<ShiftingMethod::DIFFUSION_XSPH>(numBlocks, numThreads, m_data_mgr, sortedSphMarkersD, numActive, error_flagD);
            break;
    }
