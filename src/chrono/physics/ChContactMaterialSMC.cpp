...
ChContactMaterialCompositeSMC::ChContactMaterialCompositeSMC(ChContactMaterialCompositionStrategy* strategy, const ChContactMaterialSMC* mat1, const ChContactMaterialSMC* mat2) {
