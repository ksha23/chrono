...
class CH_SENSOR_API ChVulkanRTScene {
  public:
    ...
    // Add*Light plus that function's own parameters, mirroring ChScene's backend-neutral
    ...
    void ModifyRectangleLight(unsigned int light_ID,
                              ChVector3f pos,
                              ChColor color,
                              float max_range,
                              ChVector3f length_vec,
    ...
    void ModifyDiskLight(unsigned int light_ID,
                         ChVector3f pos,
                         ChColor color,
                         float max_range,
                         ChVector3f light_dir,
