...
/// Direction TO the light from spherical angles, matching ChScene::AddDirectionalLight.
static ChVector3f DirectionFromAngles(float elevation, float azimuth) {
    return ChVector3f(std::cos(elevation) * std::cos(azimuth),
                      std::cos(elevation) * std::sin(azimuth),
                      std::sin(elevation));
}

static ChVulkanRTLight MakeSpotLight(ChVector3f pos,
                                     ChColor color,
                                     float max_range,
...
static ChVulkanRTLight MakeRectangleLight(ChVector3f pos,
                                          ChColor color,
                                          float max_range,
...
static ChVulkanRTLight MakeDiskLight(ChVector3f pos,
                                     ChColor color,
                                     float max_range,
                                     ChVector3f light_dir,
                                     float radius,
...
void ChVulkanRTScene::ModifyDirectionalLight(unsigned int light_ID, ChColor color, float elevation, float azimuth) {
    Replace(light_ID,
            MakeDirectionalLight(DirectionFromAngles(elevation, azimuth), ChVector3f(color.R, color.G, color.B)));
}
...
void ChVulkanRTScene::ModifyRectangleLight(unsigned int light_ID,
                                           ChVector3f pos,
                                           ChColor color,
                                           float max_range,
                                           ChVector3f length_vec,
...
void ChVulkanRTScene::ModifyDiskLight(unsigned int light_ID,
                                      ChVector3f pos,
                                      ChColor color,
                                      float max_range,
                                      ChVector3f light_dir,
