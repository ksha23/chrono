...
//
// PUBLIC API PARITY: the scene-setup surface below mirrors chrono::sensor::ChScene
...
// whether `manager->scene` is a ChScene (OptiX build) or a ChMetalRTScene (Metal
// build). See the "Metal-only extensions" section at the bottom for the few members
// that have no ChScene counterpart, and why.
// =============================================================================
...
class CH_SENSOR_API ChMetalRTScene {
  public:
    ...
    // =========================================================================
    // Scene API -- mirrors chrono::sensor::ChScene exactly. Keep in sync.
    // =========================================================================
    ...
    /// ChScene::AddEnvironmentLight. Also sets the background to that map, so the same
    ...
    // =========================================================================
    // Metal-only extensions (no chrono::sensor::ChScene counterpart)
    //
  ...
  private:
    ...
    Background m_background;  // defaults to SOLID_COLOR black, as ChScene's does
